<x-app-layout>
    ...
    <div id="edit-modal" class="hidden relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center">
                ...
                <div id="edit-panel" class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all duration-300 ease-out scale-90 opacity-0 w-full max-w-lg border border-gray-200">
    ...
    <div id="delete-modal" class="hidden fixed inset-0 z-[60]" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center">
                ...
                <div id="delete-panel" class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all duration-300 ease-out scale-90 opacity-0 w-full max-w-lg border border-gray-200">
    ...
    <script>
        ...
        // LOGIKA EDIT MODAL (BOUNCE ANIMATION)
        ...
        function openEditModal(buttonElement) {
            ...
            setTimeout(() => {
                ...
                // Hapus scale-90 dan opacity-0 agar zoom ke ukuran normal
                editPanel.classList.remove('scale-90', 'opacity-0');
            }, 10);
        }

        function closeEditModal() {
            editOverlay.classList.add('opacity-0');
            // Kembalikan ke scale-90 dan opacity-0 (shrink)
            editPanel.classList.add('scale-90', 'opacity-0');
            setTimeout(() => editModal.classList.add('hidden'), 300);
        }

        // LOGIKA DELETE MODAL (BOUNCE ANIMATION)
