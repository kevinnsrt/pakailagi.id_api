<x-app-layout>
    ...
    <script>
        ...
        function animateFromButton(panel, buttonElement, overlay) {
            ...
            panel.style.transform = 'scale(0.95)'; // Sedikit lebih besar (95%) agar zoomnya smooth
            
            // 2. Hitung Posisi (Origin Logic)
            if (buttonElement) {
            ...
            // 4. Jalankan Animasi (Gentle Curve & Slower Duration)
            // 0.4s + cubic-bezier overshoot
        ...
        function animateClose(panel, overlay, callbackWrapper) {
            // Animasi tutup: Lebih cepat, tanpa bounce
