    ...
    <div id="edit-modal" class="hidden relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-0 text-center sm:items-center sm:p-0">
                ...
                <div id="edit-panel" class="relative transform overflow-hidden rounded-t-2xl sm:rounded-xl bg-white text-left shadow-xl transition-all duration-300 ease-out translate-y-full w-full max-w-lg border border-gray-200">
    ...
    <div id="delete-modal" class="hidden fixed inset-0 z-[60]" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div id="delete-panel" class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all duration-300 ease-out translate-y-full w-full max-w-lg border border-gray-200">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            if (toastSuccess) {
                ...
                // Slide Up (Keluar) setelah 5 detik
        ...
        function openEditModal(buttonElement) {
            ...
            setTimeout(() => {
                ...
                // Hapus translate-y-full agar naik ke posisi normal
                editPanel.classList.remove('translate-y-full');
            }, 20); // Delay kecil agar transisi berjalan
        }
        ...
        // --- 3. DELETE MODAL (Slide Animation) ---
        ...
        function openDeleteModal() {
            ...
            setTimeout(() => {
                ...
                deletePanel.classList.remove('translate-y-full');
            }, 20);
        }

        function closeDeleteModal() {
            deleteOverlay.classList.add('opacity-0');
            deletePanel.classList.add('translate-y-full');
