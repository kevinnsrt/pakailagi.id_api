<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-gray-900">Rp {{ number_format($pendapatan, 0, ',', '.') }}</h3>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-gray-900">{{ $pesananAktif }} <span class="text-xs font-normal text-gray-400">Pesanan</span></h3>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-gray-900">{{ $totalProduk }} <span class="text-xs font-normal text-gray-400">Unit</span></h3>
                    </div>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center">
                    <div class="p-3 bg-orange-50 rounded-full text-orange-600 mr-4">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 font-medium">Total Pengguna</p>
                        <h3 class="text-xl font-bold text-gray-900">{{ $totalUser }} <span class="text-xs font-normal text-gray-400">User</span></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Penjualan per Kategori (Selesai)</h3>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h3 class="text-lg font-semibold text-gray-800">5 Pesanan Terbaru</h3>
                    <a href="{{ route('history.admin') }}" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">Lihat Semua &rarr;</a>
                </div>
    ...
    <script>
        // 1. Definisikan Data dari PHP ke Variabel JS TERLEBIH DAHULU
        // Ini mencegah error "Decorators not valid" atau "Property assignment expected" di editor
        ...
        // 2. CHART STATUS PESANAN (Doughnut)
        const ctxStatus = document.getElementById('statusChart').getContext('2d');
        new Chart(ctxStatus, {
            type: 'doughnut',
            data: {
                labels: statusLabels, // Menggunakan variabel JS bersih
                datasets: [{
                    data: statusData, // Menggunakan variabel JS bersih
                    backgroundColor: [
                        '#F3F4F6', // Dikeranjang (Gray)
                        '#6366F1', // Diproses (Indigo)
                        '#3B82F6', // Dikirim (Blue)
        ...
        new Chart(ctxCategory, {
            type: 'bar',
            data: {
                labels: categoryLabels, // Menggunakan variabel JS bersih
                datasets: [{
                    label: 'Jumlah Terjual',
                    data: categoryData, // Menggunakan variabel JS bersih
